...
//import com.github.skrcode.javaautounittests.dto.DiffHunk;
...
//
//    private final Map<DiffHunk, JCheckBox> selectedMap = new LinkedHashMap<>();
//
//    private JPanel root;
//
...
//
//        List<DiffHunk> hunks = diffResult.hunks != null ? diffResult.hunks : List.of();
//
//        if (hunks.isEmpty()) {
...
//    }
//
//    private JComponent createHunkBox(DiffHunk hunk, int index) {
//
...
//
//        String original = diffResult.originalSource;
//        List<DiffHunk> hunks = diffResult.hunks != null
