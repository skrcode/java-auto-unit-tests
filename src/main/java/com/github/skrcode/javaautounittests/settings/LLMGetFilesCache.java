...
public final class LLMGetFilesCache
        implements PersistentStateComponent<LLMGetFilesCache.State> {
    ...
    public static LLMGetFilesCache getInstance(@NotNull Project project) {
        return project.getService(LLMGetFilesCache.class);
    }
